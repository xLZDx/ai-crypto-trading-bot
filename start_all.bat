...
echo Launching ML Training in background (non-blocking)...
start "ML Training [4/4]" cmd /c "if exist venv\Scripts\activate.bat (call venv\Scripts\activate.bat) & python src\engine\train_all_models.py & echo Training complete. & pause"
